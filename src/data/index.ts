export const course = {
  ...
  meta: {
    ...
    skills: [
      "../Aligning your goals with your mot",
  ...
  lessons: [
    ...
    {
      id: "../a7ffcfb9-32b0-4bb8-8c41-ed5e2a45",
...
export const courses = {
  courses: [
    ...
    },
    {
      ...
      status: "launched",
      description:
        "../Achieve anything you want by defining goalst actually matter to you.",
      duration: 566,
      lessonsCount: 2,
      containsLockedLessons: true,
      previewImageLink:
    ...
    },
    {
      ...
      status: "launched",
      description:
        "../After this course, you’ll be able to aim your focs easily as a laser pointer.",
      duration: 1468,
      lessonsCount: 5,
      containsLockedLessons: false,
      previewImageLink:
    ...
    {
      id: "../a99646f9-718a-4687-842e-4994a8ca",
    ...
    {
      id: "../a31a7531-6bae-4592-a4d3-97a663f5",
    ...
    },
    {
      ...
      title: "../A Road to Healthy Relations",
      tags: ["psychology"],
      ...
      rating: 4.7,
      meta: {
        slug: "../a-road-to-healthy-relations",
        skills: [
          "Mutual respect",
          "../Ahcieving intim",
          "Building trust ",
    ...
    },
    {
      ...
      meta: {
        ...
        fullCourseProductId: "../a0e4d025-ecea-489d-a340-a3af959a",
